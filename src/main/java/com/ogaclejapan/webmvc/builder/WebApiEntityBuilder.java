...
/**
 * {@link ApiEntity}のモデルをメソッドチェーンで組み立てるベースクラス
 * @author ogaclejapan
 * 
 * @param <T>
 */
public abstract class WebApiEntityBuilder<T> extends ApiEntity implements ModelBuilder<T> {
	
	private static final Logger logger = LoggerFactory.getLogger(WebApiEntityBuilder.class);

	//__/__/__/__/__/__/__/__/__/__/
	// Constructors
	//__/__/__/__/__/__/__/__/__/__/

	public WebApiEntityBuilder(HttpStatus statusCode) {
		super(statusCode);
	}
